...
#Find out the  number of leafs and print their name
# to do this trace the function newick2nodes with a simple tree like
# ((A,B),(C,D),(E,F));

nleaf=0
for n in nodes:
    if n>0 and nodes[n].name!="":
        print (nodes[n].name)
        nleaf+=1
sys.stdout.write ("Nleaf=%d\n"%(nleaf))
